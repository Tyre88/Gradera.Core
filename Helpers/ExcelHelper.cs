...
namespace Gradera.Core.Helpers
{
    public class ExcelHelper
    {
        ...
        public static string CreateExcelDocument(DataTable dt, string workSheetName, bool printHeaders)
        {
            string path = string.Format(@"{0}Downloads\Competition\", AppDomain.CurrentDomain.BaseDirectory);
