...
namespace Gradera.Core.DAL
{
    ...
    public partial class CoreModel : DbContext
    {
        ...
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Account_Session>("GetActiveAccountSessions");
        }
    
        public virtual ObjectResult<Account_Session> GetActiveAccountSessions(MergeOption mergeOption)
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Account_Session>("GetActiveAccountSessions", mergeOption);
        }
    }
}
